...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
//nestedFunction can access the outside variable because it's inside the myFunction. Nested functions can access any variable that is declared in their parent. This is due to their scope, but parent functions cannot access variables delcared inside their child functions.
...
function animalNames(array) {
  const total = [];
  array.forEach((e) => {
    total.push(`name: ${e.animal_name}, scientific: ${e.scientific_name}`);
  });
  return total;
}
...
CuboidMaker.prototype.volume = function () {
  const total = this.length * this.width * this.height;
  return total;
};
